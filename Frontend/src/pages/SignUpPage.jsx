          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="w-full p-3 bg-transparent border-b border-gray-400 focus:border-primary focus:outline-none"
            ...
            <div className="form-control">
              ...
              <label className="label">
                <span className="label-text-alt text-base-content/60">Only letters, numbers, and underscores allowed</span>
              </label>
            </div>
